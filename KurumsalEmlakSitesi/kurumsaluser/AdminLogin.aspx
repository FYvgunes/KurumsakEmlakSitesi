<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="KurumsalEmlakSitesi.kurumsaluser.AdminLogin" %>
            ...
            <div class="login-box-body">
                ...
                <form method="post">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-xs-4">
                            <asp:Button runat="server" type="submit" ID="btn_giris" CssClass="btn btn-primary btn-block btn-flat" Text="Giriş" />
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
