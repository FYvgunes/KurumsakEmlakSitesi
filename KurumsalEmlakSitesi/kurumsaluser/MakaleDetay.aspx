<%@ Page Title="" Language="C#" MasterPageFile="~/kurumsaluser/Admin.Master" AutoEventWireup="true" CodeBehind="MakaleDetay.aspx.cs" Inherits="KurumsalEmlakSitesi.kurumsaluser.MakaleDetay" %>
                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label id="Label5" runat="server">Özet</label>
